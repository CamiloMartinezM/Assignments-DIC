...
\end{homeworkProblem}
\begin{homeworkProblem}{Morphology with a Disk}
    \textbf{See related files.}
\end{homeworkProblem}
\begin{homeworkProblem}{Euclidean Distance Transformation}
    \textbf{See related files.} We set disk radius $t = 5$.
\end{homeworkProblem}
\end{document}
