...
/*--------------------------------------------------------------------------*/
/*                                                                          */
/*                 HOMOEGENOUS DIFFUSION, EXPLICIT SCHEME                   */
/*                                                                          */
/*                 (Copyright by Joachim Weickert, 1/2020)                  */
/*                                                                          */
/*--------------------------------------------------------------------------*/
...
/*
  explicit step of a homogeneous diffusion filter
*/
...
for (i=1; i<=nx; i++)
 for (j=1; j<=ny; j++)
     f[i][j] = u[i][j] 
               + aux1 * (u[i+1][j] - 2.0 * u[i][j] + u[i-1][j]) 
               + aux2 * (u[i][j+1] - 2.0 * u[i][j] + u[i][j-1]);
...
printf ("\n");
printf ("HOMOGENEOUS DIFFUSION FILTER, EXPLICIT SCHEME\n\n");
printf ("**************************************************\n\n");
...
comments[0] = '\0';
comment_line (comments, "# homogeneous diffusion, explicit scheme\n");
